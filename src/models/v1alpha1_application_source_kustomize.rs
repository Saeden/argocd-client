...
pub struct V1alpha1ApplicationSourceKustomize {
    ...
    #[serde(rename = "commonAnnotationsEnvsubst", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "forceCommonAnnotations", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ignoreMissingComponents", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "labelIncludeTemplates", skip_serializing_if = "Option::is_none")]
    pub label_include_templates: Option<bool>,
    #[serde(rename = "labelWithoutSelector", skip_serializing_if = "Option::is_none")]
