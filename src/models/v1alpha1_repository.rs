...
pub struct V1alpha1Repository {
    ...
    #[serde(
        rename = "gcpServiceAccountKey",
        skip_serializing_if = "Option::is_none"
    )]
    pub gcp_service_account_key: Option<String>,
    #[serde(
        rename = "githubAppEnterpriseBaseUrl",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "githubAppInstallationID",
        skip_serializing_if = "Option::is_none"
    )]
    pub github_app_installation_id: Option<i64>,
    #[serde(
        rename = "githubAppPrivateKey",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "useAzureWorkloadIdentity",
        skip_serializing_if = "Option::is_none"
    )]
