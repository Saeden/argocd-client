...
pub struct ClusterSettings {
    ...
    #[serde(
        rename = "appsInAnyNamespaceEnabled",
    ...
    pub resource_overrides:
        Option<std::collections::HashMap<String, models::V1alpha1ResourceOverride>>,
