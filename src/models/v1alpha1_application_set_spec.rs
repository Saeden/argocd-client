...
pub struct V1alpha1ApplicationSetSpec {
    ...
    #[serde(rename = "applyNestedSelectors", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ignoreApplicationDifferences", skip_serializing_if = "Option::is_none")]
    pub ignore_application_differences: Option<Vec<models::V1alpha1ApplicationSetResourceIgnoreDifferences>>,
